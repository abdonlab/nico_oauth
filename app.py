...
st.set_page_config(
    ...
    page_icon="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAYAAABzenr0AAAARGVYSWZNTQAqAAA...QFGxyYoLS0m8Y3RFDFVbwkS+XUGuID7/wfpWrcPxMXUMQAAAABJRU5ErkJggg==", 
    layout="wide",
)
