...
# (con búsqueda en internet / Google Search)
# ============================================================
...
def speak_browser(text: str):
    ...
    con una voz más neutra / grave en español si está disponible.
    """
    if not text:
        return
    ...
    (function() {{
        ...
        function speak() {{
            ...
            // 1) Buscar voz masculina/neutra en español por nombre
    ...
    for msg in reversed(st.session_state["history"][-20:]):
        if msg["role"] == "user":
            ...
            with st.chat_message("assistant"):
                ...
                # Voz en el navegador (masculina/neutra/grave)
