...
with conv_col:
    ...
    if st.session_state["trigger_run"]:
        ...
        sys_prompt = (
            ...
            "- https://www.umich.mx\n"
            "para ultimas noticias busca en las web un resumen y en las paginas oficiales de la umsnh.mx al final recomineda buscar en https://www.gacetanicolaita.umich.mx/"
